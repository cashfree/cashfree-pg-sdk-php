...
use Cashfree\Model\CFSettlementsEntity;
...
class SettlementsApi
{
     ...
     * @return \Cashfree\Api\CFSettlementsResponse|\Cashfree\Model\CFError
     */
     ...
     * @throws \Cashfree\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Cashfree\Model\CFSettlementsEntity|\Cashfree\Model\CFError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getsettlementsWithHttpInfo($x_client_id, $x_client_secret, $order_id, $x_api_version = '2022-01-01', $x_idempotency_replayed = false, $x_idempotency_key = null, $x_request_id = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Cashfree\Model\CFSettlementsEntity' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Cashfree\Model\CFSettlementsEntity', []),
            ...
            $returnType = '\Cashfree\Model\CFSettlementsEntity';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Cashfree\Model\CFSettlementsEntity',
