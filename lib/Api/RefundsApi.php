...
use cashfree\Client\Model\CFRefund;
...
class RefundsApi
{
     ...
     * @param  \cashfree\Client\Model\CFRefundRequest $cf_refund_request cf_refund_request (optional)
     *
     * @throws \cashfree\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \cashfree\Client\Api\CFRefundResponse|\cashfree\Client\Model\CFError
     */
     ...
     * @param  \cashfree\Client\Model\CFRefundRequest $cf_refund_request (optional)
     *
     * @throws \cashfree\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \cashfree\Client\Model\CFRefund|\cashfree\Client\Model\CFError, HTTP status code, HTTP response headers (array of strings)
     */
    public function createrefundWithHttpInfo($x_client_id, $x_client_secret, $order_id, $x_api_version = '2022-01-01', $x_idempotency_replayed = false, $x_idempotency_key = null, $x_request_id = null, $cf_refund_request = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\cashfree\Client\Model\CFRefund' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\cashfree\Client\Model\CFRefund', []),
            ...
            $returnType = '\cashfree\Client\Model\CFRefund';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\cashfree\Client\Model\CFRefund',
     ...
     * @throws \cashfree\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \cashfree\Client\Api\CFAllRefundResponse|\cashfree\Client\Model\CFError
     */
