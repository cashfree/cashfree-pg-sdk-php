 ...
 */
class OfferDetailsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OfferDetailsResponse';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['offer_type']) && (mb_strlen($this->container['offer_type']) > 50)) {
            $invalidProperties[] = "invalid value for 'offer_type', the character length must be smaller than or equal to 50.";
        }

        if (!is_null($this->container['offer_type']) && (mb_strlen($this->container['offer_type']) < 3)) {
     ...
     * Sets offer_type
     *
     * @param string|null $offer_type Offer Type for the Offer.
     *
     * @return self
     */
    public function setOfferType($offer_type)
    {
        ...
        if ((mb_strlen($offer_type) > 50)) {
            throw new \InvalidArgumentException('invalid length for $offer_type when calling OfferDetailsResponse., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($offer_type) < 3)) {
            throw new \InvalidArgumentException('invalid length for $offer_type when calling OfferDetailsResponse., must be bigger than or equal to 3.');
        }
