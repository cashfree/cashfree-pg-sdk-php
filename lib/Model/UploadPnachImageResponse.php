...
/**
 * UploadPnachImageResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class UploadPnachImageResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UploadPnachImageResponse';
    ...
    */
     ...
     * Sets payment_id
     *
     * @param string|null $payment_id The payment_id against which the pnach image is uploaded.
     *
     * @return self
     */
     ...
     *
     * @param string|null $authorization_status Authorization status of the subscription.
     *
     * @return self
     */
     ...
     * Sets action
     *
     * @param string|null $action Action performed on the file.
     *
     * @return self
     */
     ...
     *
     * @param string|null $payment_message Message of the API.
     *
     * @return self
     */
