...
class RefundWebhook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Cashfree\Model\PaymentWebhookDataEntity1',
        'event_time' => 'string',
        'type' => 'string'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Cashfree\Model\PaymentWebhookDataEntity1|null
     */
     ...
     * Sets data
     *
     * @param \Cashfree\Model\PaymentWebhookDataEntity1|null $data data
     *
     * @return self
     */
