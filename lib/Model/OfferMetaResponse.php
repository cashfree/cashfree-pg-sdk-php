...
/**
 * OfferMetaResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class OfferMetaResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OfferMetaResponse';
    ...
    */
     ...
     * Sets offer_code
     *
     * @param string|null $offer_code Unique identifier for the Offer.
     *
     * @return self
     */
    public function setOfferCode($offer_code)
    {
        ...
        if ((mb_strlen($offer_code) > 45)) {
            throw new \InvalidArgumentException('invalid length for $offer_code when calling OfferMetaResponse., must be smaller than or equal to 45.');
        }
        if ((mb_strlen($offer_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $offer_code when calling OfferMetaResponse., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $offer_description Description for the Offer.
     *
     * @return self
     */
    public function setOfferDescription($offer_description)
    {
        ...
        if ((mb_strlen($offer_description) > 100)) {
            throw new \InvalidArgumentException('invalid length for $offer_description when calling OfferMetaResponse., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($offer_description) < 3)) {
            throw new \InvalidArgumentException('invalid length for $offer_description when calling OfferMetaResponse., must be bigger than or equal to 3.');
        }
     ...
     * Sets offer_end_time
     *
     * @param string|null $offer_end_time Expiry Time for the Offer
     *
     * @return self
     */
     ...
     *
     * @param string|null $offer_start_time Start Time for the Offer
     *
     * @return self
     */
    public function setOfferStartTime($offer_start_time)
    {
        ...
        if ((mb_strlen($offer_start_time) > 20)) {
            throw new \InvalidArgumentException('invalid length for $offer_start_time when calling OfferMetaResponse., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($offer_start_time) < 3)) {
            throw new \InvalidArgumentException('invalid length for $offer_start_time when calling OfferMetaResponse., must be bigger than or equal to 3.');
        }
     ...
     * Sets offer_title
     *
     * @param string|null $offer_title Title for the Offer.
     *
     * @return self
     */
    public function setOfferTitle($offer_title)
    {
        ...
        if ((mb_strlen($offer_title) > 50)) {
            throw new \InvalidArgumentException('invalid length for $offer_title when calling OfferMetaResponse., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($offer_title) < 3)) {
            throw new \InvalidArgumentException('invalid length for $offer_title when calling OfferMetaResponse., must be bigger than or equal to 3.');
        }
