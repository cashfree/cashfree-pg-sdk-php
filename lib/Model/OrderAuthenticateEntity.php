...
/**
 * OrderAuthenticateEntity Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderAuthenticateEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderAuthenticateEntity';
    ...
    public const ACTION_SUBMIT_OTP = 'SUBMIT_OTP';
    public const ACTION_RESEND_OTP = 'RESEND_OTP';
    public const ACTION_UNKNOWN_DEFAULT_OPEN_API = 'unknown_default_open_api';
    public const AUTHENTICATE_STATUS_FAILED = 'FAILED';
    public const AUTHENTICATE_STATUS_SUCCESS = 'SUCCESS';
    public const AUTHENTICATE_STATUS_UNKNOWN_DEFAULT_OPEN_API = 'unknown_default_open_api';
    ...
    {
        return [
            self::ACTION_SUBMIT_OTP,
            self::ACTION_RESEND_OTP,
    ...
    {
        return [
            self::AUTHENTICATE_STATUS_FAILED,
            self::AUTHENTICATE_STATUS_SUCCESS,
            self::AUTHENTICATE_STATUS_UNKNOWN_DEFAULT_OPEN_API,
        ];
    }
    ...
    */
     ...
     * Sets cf_payment_id
     *
     * @param string|null $cf_payment_id The payment id for which this request was sent
     *
     * @return self
     */
     ...
     * Sets action
     *
     * @param string|null $action The action that was invoked for this request.
     *
     * @return self
     */
     ...
     *
     * @param string|null $authenticate_status Status of the is action. Will be either failed or successful. If the action is successful, you should still call the authorization status to verify the final payment status.
     *
     * @return self
     */
     ...
     *
     * @param string|null $payment_message Human readable message which describes the status in more detail
     *
     * @return self
     */
