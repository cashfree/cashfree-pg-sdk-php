...
/**
 * SettlementReconEntityDataInnerCustomerDetails Class Doc Comment
 *
 * @category Class
 * @package  Cashfree
 * @author   OpenAPI Generator team
 ...
 */
class SettlementReconEntityDataInnerCustomerDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SettlementReconEntity_data_inner_customer_details';
    ...
    */
     ...
     * Sets customer_id
     *
     * @param string|null $customer_id Customer's id.
     *
     * @return self
     */
     ...
     *
     * @param string|null $customer_bank_code Customer bank code.
     *
     * @return self
     */
