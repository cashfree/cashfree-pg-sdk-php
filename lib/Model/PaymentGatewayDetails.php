...
/**
 * PaymentGatewayDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentGatewayDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentGatewayDetails';
    ...
    protected static $openAPINullables = [
		...
		'gateway_order_reference_id' => false,
		'gateway_status_code' => false,
		'gateway_settlement' => false,
		'gateway_reference_name' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'gateway_order_reference_id' => 'gateway_order_reference_id',
        'gateway_status_code' => 'gateway_status_code',
        'gateway_settlement' => 'gateway_settlement',
        'gateway_reference_name' => 'gateway_reference_name'
    ];
    ...
    protected static $setters = [
        ...
        'gateway_order_reference_id' => 'setGatewayOrderReferenceId',
        'gateway_status_code' => 'setGatewayStatusCode',
        'gateway_settlement' => 'setGatewaySettlement',
        'gateway_reference_name' => 'setGatewayReferenceName'
    ];
    ...
    protected static $getters = [
        ...
        'gateway_order_reference_id' => 'getGatewayOrderReferenceId',
        'gateway_status_code' => 'getGatewayStatusCode',
        'gateway_settlement' => 'getGatewaySettlement',
        'gateway_reference_name' => 'getGatewayReferenceName'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('gateway_order_reference_id', $data ?? [], null);
        $this->setIfExists('gateway_status_code', $data ?? [], null);
        $this->setIfExists('gateway_settlement', $data ?? [], null);
        $this->setIfExists('gateway_reference_name', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets gateway_order_reference_id
     *
     * @return string|null
     */
    public function getGatewayOrderReferenceId()
    {
        return $this->container['gateway_order_reference_id'];
    }

    /**
     * Sets gateway_order_reference_id
     *
     * @param string|null $gateway_order_reference_id gateway_order_reference_id
     *
     * @return self
     */
    public function setGatewayOrderReferenceId($gateway_order_reference_id)
    {
        if (is_null($gateway_order_reference_id)) {
            throw new \InvalidArgumentException('non-nullable gateway_order_reference_id cannot be null');
        }
        $this->container['gateway_order_reference_id'] = $gateway_order_reference_id;
    ...
    /**
     * Gets gateway_reference_name
     *
     * @return string|null
     */
    public function getGatewayReferenceName()
    {
        return $this->container['gateway_reference_name'];
    }

    /**
     * Sets gateway_reference_name
     *
     * @param string|null $gateway_reference_name gateway_reference_name
     *
     * @return self
     */
    public function setGatewayReferenceName($gateway_reference_name)
    {
        if (is_null($gateway_reference_name)) {
            throw new \InvalidArgumentException('non-nullable gateway_reference_name cannot be null');
        }
        $this->container['gateway_reference_name'] = $gateway_reference_name;
