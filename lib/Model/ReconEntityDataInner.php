...
class ReconEntityDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param float|null $forex_conversion_handling_charge Cashfree forex conversion charges for processing transaction
     *
     * @return self
     */
     ...
     *
     * @param float|null $forex_conversion_handling_tax Cashfree forex conversion tax for processing transaction
     *
     * @return self
     */
     ...
     *
     * @param string|null $charges_currency Cashfree charges currency for a event type
     *
     * @return self
     */
