...
/**
 * EMIPlansArray Class Doc Comment
 *
 * @category Class
 ...
 */
class EMIPlansArray implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EMIPlansArray';
    ...
    */
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 50)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling EMIPlansArray., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling EMIPlansArray., must be bigger than or equal to 3.');
        }
     ...
     * Sets total_interest
     *
     * @param int|null $total_interest total_interest
     *
     * @return self
     */
