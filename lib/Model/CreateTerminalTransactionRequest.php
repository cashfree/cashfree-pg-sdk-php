...
class CreateTerminalTransactionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets cf_order_id
     *
     * @param int $cf_order_id cashfree order ID that was returned while creating an order.
     *
     * @return self
     */
     ...
     * Sets cf_terminal_id
     *
     * @param int|null $cf_terminal_id cashfree terminal id. this is a required parameter when you do not provide the terminal phone number.
     *
     * @return self
     */
