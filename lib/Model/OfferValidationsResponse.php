...
/**
 * OfferValidationsResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class OfferValidationsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OfferValidationsResponse';
    ...
    protected static $openAPITypes = [
        'max_allowed' => 'float',
        'min_amount' => 'float',
        'payment_method' => '\Cashfree\Model\OfferValidationsResponsePaymentMethod'
    ];
    ...
    */
     ...
     * Sets max_allowed
     *
     * @param float|null $max_allowed Maximum Amount for Offer to be Applicable
     *
     * @return self
     */
    public function setMaxAllowed($max_allowed)
    {
        ...
        if (($max_allowed < 1)) {
            throw new \InvalidArgumentException('invalid value for $max_allowed when calling OfferValidationsResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setMinAmount($min_amount)
    {
        ...
        if (($min_amount < 1)) {
            throw new \InvalidArgumentException('invalid value for $min_amount when calling OfferValidationsResponse., must be bigger than or equal to 1.');
        }
     ...
     * Gets payment_method
     *
     * @return \Cashfree\Model\OfferValidationsResponsePaymentMethod|null
     */
     ...
     * Sets payment_method
     *
     * @param \Cashfree\Model\OfferValidationsResponsePaymentMethod|null $payment_method payment_method
     *
     * @return self
     */
