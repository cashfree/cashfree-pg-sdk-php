...
```php
getPaymentbyId($x_client_id, $x_client_secret, $order_id, $cf_payment_id, $x_api_version, $x_idempotency_replayed, $x_idempotency_key, $x_request_id): \cashfree\Client\Model\CFPaymentsEntity
```
...
$apiInstance = new cashfree\Client\Api\PaymentsApi(
...
```php
getPaymentsfororder($x_client_id, $x_client_secret, $order_id, $x_api_version, $x_idempotency_replayed, $x_idempotency_key, $x_request_id): \cashfree\Client\Model\CFPaymentsEntity[]
```
