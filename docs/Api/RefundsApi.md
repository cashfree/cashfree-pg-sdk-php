...
```php
createrefund($x_client_id, $x_client_secret, $order_id, $x_api_version, $x_idempotency_replayed, $x_idempotency_key, $x_request_id, $cf_refund_request): \cashfree\Client\Model\CFRefund
```
...
$apiInstance = new cashfree\Client\Api\RefundsApi(
...
$cf_refund_request = new \cashfree\Client\Model\CFRefundRequest(); // \cashfree\Client\Model\CFRefundRequest
 ...
 **cf_refund_request** | [**\cashfree\Client\Model\CFRefundRequest**](../Model/CFRefundRequest.md)|  | [optional]

### Return type

[**\cashfree\Client\Model\CFRefund**](../Model/CFRefund.md)
...
```php
getRefund($x_client_id, $x_client_secret, $order_id, $refund_id, $x_api_version, $x_idempotency_replayed, $x_idempotency_key, $x_request_id): \cashfree\Client\Model\CFRefund
```
...
```php
getallrefundsfororder($x_client_id, $x_client_secret, $order_id, $x_api_version): \cashfree\Client\Model\CFRefund[]
```
